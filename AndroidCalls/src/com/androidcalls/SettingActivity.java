...
public class SettingActivity extends Activity {
	...
	protected void onResume() {
		...
		super.onResume();
		setDetectEnabled(Utility.getBooleanPreferences(SettingActivity.this,
				"isBlocking"));
	...
	private void setDetectEnabled(boolean enable) {
		...
		if (enable) {
			...
			Utility.setBooleanPreferences(SettingActivity.this, "isBlocking", true);
		} else {
			// stop detect service
			stopService(intent);
			...
			Utility.setBooleanPreferences(SettingActivity.this, "isBlocking",
					false);
		}
	}
