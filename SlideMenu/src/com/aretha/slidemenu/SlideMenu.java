...
public class SlideMenu extends ViewGroup {
	...
	public boolean mIsTapInEdgeSlide;
	...
	public SlideMenu(Context context, AttributeSet attrs, int defStyle) {
		...
		setEdgeSlideEnable(a.getBoolean(R.styleable.SlideMenu_edgeSlide, true));
...
//			setFocusableInTouchMode(true);
		...
		int targetOffset = isSlideLeft ? (width / 8) - width : width
				- (width / 5);
		// isSlideLeft ? mContentBoundsLeft : mContentBoundsRight;
...
//				return false;
//			}
//			if (mIsEdgeSlideEnable && mCurrentState == STATE_CLOSE) {
//				return false;
//			}
			/**
			 * new change
	...
	public static class LayoutParams extends MarginLayoutParams {
		...
		public LayoutParams(Context context, AttributeSet attrs) {
			...
			for (int index = 0; index < indexCount; index++) {
				index = a.getIndex(index);
				if (index == R.styleable.SlideMenu_Layout_layout_role) {
